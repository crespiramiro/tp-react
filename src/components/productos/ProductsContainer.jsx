...
function ProductsContainer() {
    return (  
        <section id="productos" className="h-screen w-full" >
                    <h2 className=" text-3xl text-center py-8 font-bold " >Nuestros <span className="text-green-800" > Productos</span></h2>
